# scripts/build_297_remedies.py
# Comprehensive builder for all 297 homeopathic remedies requested by the user
import json
import os
import re

# Complete list of 297 remedy names
REMEDY_LIST = [
...
print(f"Total remedies to build: {len(REMEDY_LIST)}")
