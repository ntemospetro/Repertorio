...
export class BogerSourceAdapter implements RepertorySourceAdapter {
  public sourceName = 'Boger';
  public defaultAuthor = 'Cyrus Maxwell Boger';
  public defaultWork = 'Synoptic Key of the Materia Medica';
    ...
    if (isCsv) {
      ...
      for (let i = 1; i < lines.length; i++) {
        ...
        rows.push({
          ...
          chapter: rowObj.chapter || 'GENERALS',
          rubric_id: rowObj.rubric_id || `boger_rub_${i}`,
          parent_rubric_id: rowObj.parent_rubric_id || null,
          rubric_path: rowObj.rubric_path || 'GENERALS',
          rubric_text_original: rowObj.rubric_text_original || 'Boger Rubric',
