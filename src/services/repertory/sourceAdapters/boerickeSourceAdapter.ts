...
export class BoerickeSourceAdapter implements RepertorySourceAdapter {
  public sourceName = 'Boericke';
  public defaultAuthor = 'William Boericke';
  public defaultWork = 'Pocket Manual of Homoeopathic Materia Medica';
    ...
    if (isCsv) {
      ...
      for (let i = 1; i < lines.length; i++) {
        ...
        rows.push({
          ...
          chapter: rowObj.chapter || 'THERAPEUTICS',
          rubric_id: rowObj.rubric_id || `boericke_rub_${i}`,
          parent_rubric_id: rowObj.parent_rubric_id || null,
          rubric_path: rowObj.rubric_path || 'THERAPEUTICS',
          rubric_text_original: rowObj.rubric_text_original || 'Boericke Rubric',
